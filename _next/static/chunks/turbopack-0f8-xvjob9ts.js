(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, {
    otherChunks: ["static/chunks/0gxwci3e5-ykx.js", "static/chunks/00qufzjpxq00u.js", "static/chunks/10u3y4bw1ayzs.js"],
...
( () => {
    ...
    s.a = function(e, t) {
        ...
        e(function(e) {
            ...
            function s(e) {
                e !== n && !o.has(e) && (o.add(e),
                e && 0 === e.status && (u.queueCount++,
                e.push(u)))
            }
            return t.map(e => e[k](s)),
            u.queueCount ? i : r()
        }, function(e) {
            e ? l(s[C] = e) : i(s[U]),
            P(n)
    ...
    async function T(e, t, r) {
        ...
        if (u.length > 0) {
            if (u.length === l.length)
                return void await Promise.all(u);
            let r = new Set;
            for (let e of l)
                _.has(e) || r.add(e);
            for (let n of r) {
    ...
    S.b = function(e, t, o, i) {
        ...
        let s = new URL(q(t),location.origin)
          , a = JSON.stringify(u);
        return l ? s.searchParams.set("params", a) : s.hash = "#params=" + encodeURIComponent(a),
        new e(s,i ? {
            ...i,
            type: void 0
        } : void 0)
...
;(function() {
    ...
    s.setAttribute("data-deployment-id", "dpl_6wgJwi1KY3Sy6HGEBLGPNGKkf6bc");
